...
void main()
{
    ...
    int tes0 = int(mix(256.0, 2.0, clamp(dist0/8.0, 0.0, 1.0)));
    int tes1 = int(mix(256.0, 2.0, clamp(dist1/8.0, 0.0, 1.0)));
    int tes2 = int(mix(256.0, 2.0, clamp(dist2/8.0, 0.0, 1.0)));
    int tes3 = int(mix(256.0, 2.0, clamp(dist3/8.0, 0.0, 1.0)));
